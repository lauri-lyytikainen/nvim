...
function delete_other_buffers(force)
...
nmap_leader('bo', '<Cmd>lua delete_other_buffers(false)<CR>', 'Delete others')
nmap_leader('bO', '<Cmd>lua delete_other_buffers(true)<CR>', 'Delete! others')
