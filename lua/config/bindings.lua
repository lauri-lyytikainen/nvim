...
-- Telescope Bindings
keymap.set('n', '<M-t>', '<Cmd>BrowseFiles<CR>', { silent = false }, { desc = "Browse Files" })
keymap.set('n', '<M-r>', '<Cmd>ResumeSearch<CR>', { silent = true }, { desc = "Resume Search" })
keymap.set('n', '<M-f>', '<Cmd>FileParse<CR>', { silent = true }, { desc = "File Parse" })
keymap.set('n', '<M-l>', '<cmd>Telescope live_grep<cr>', { silent = true }, { desc = "Live Grep" })
keymap.set('n', '<M-w>', '<Cmd>Telescope diagnostics<CR>', { silent = true }, { desc = "Show Diagnostics" })
...
keymap.set('n', '<M-b>', '<Cmd>DapToggleBreakpoint<CR>', { desc = "Toggle Breakpoint" })
